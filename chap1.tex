...
\index{Bravais (réseau de)}
\index{mode cristallin}
\begin{description}
...
\subsubsection{Nombre de motifs par maille}\index{maille}
...
\subsubsection{Coordinence}\index{coordinence}
...
\emph{réseau h\^ote}.\index{réseau}
...
\end{defi}
\begin{ex}[cf figure~\ref{fig:2_cfc_sites}]
    \begin{compactdesc}
...
\section{Les différents modèles de cristaux}\index{cristal}
\begin{description}
...
\begin{ex}[Cristaux métalliques]
    \begin{compactdesc}
        \item[CC] Fer $\alpha$, Chrome, Tungstène, \dots
            \index{fer}\index{chrome}\index{tungstène}
        \item[CFC] Fer $\gamma$, Or, Ag, Aluminium, Cuivre, \dots
            \index{or}\index{argent}\index{aluminium}\index{cuivre}
        \item[HC] Zinc, Titane, Cadmium, \dots
            \index{zinc}\index{titane}\index{cadmium}
