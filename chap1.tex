...
\begin{ex}[le verre]\index{verre}
    ...
    d’énorme viscosité. Cette forme de la matière est appelée état vitreux.
\end{ex}
...
\begin{rem}
    ...
    état cristallin \emph{parfaitement ordonné} à très grande distance
...
\end{figure}
Un cristal est l'association d'un réseau et d'un motif placé aux n\oe uds du
réseau.\index{cristal}

\subsection{Maille}\index{maille}
Les n\oe uds du réseau se déduisent les uns des autres par des opérations
...
nécessairement des portions d'espace non occupé puisque $C < 1$; ils
constituent des \emph{sites}. Le réseau constitué des sphères $S$ s'appelle le
