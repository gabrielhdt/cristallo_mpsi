...
sphères sont au contact).\index{compacité}
...
\index{énergie de cohésion!CC}
et non directionnelle. Elle est à l’origine de certaines
\index{directionnelle (liaison)}
propriétés macroscopiques des métaux :
\begin{itemize}
    \item température de fusion élevée \index{température de fusion!CC}
        \index{CC!température de fusion}
