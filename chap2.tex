...
\begin{figure}
    \centering
    \subfloat[Plan A]
    {\includegraphics[width=7cm]{chap2/plan_a.png}}
    \qquad
    \subfloat[Plan B]
    {\includegraphics[width=6.55cm]{chap2/plan_b.png}}
    \qquad
    \subfloat[Plan C]
    {\includegraphics[width=6cm]{chap2/plan_c.png}}
...
\begin{figure}
    \centering
    \includegraphics[width=9cm]{chap2/plan_ab_hc.png}
...
\begin{figure}
    \centering
    \includegraphics[width=9cm]{chap2/met_cfc_hc.png}
