\chapter{Les cristaux métalliques}
...
\begin{ex}[Cas du fer $\gamma$]\index{fer}
    ...
    plus fragiles que le fer pur.\\\index{propriétés mécaniques}
    \index{fer}\index{fonte}\index{carbone}\index{azote}
...
\begin{rem}
    ...
    Pour le magnésium, le rapport vaut\index{magnésium}
    $\np{1,62}$.Cette valeur est très proche de celle
    obtenue ci-dessus, les atomes sont des sphères
    au contact. Pour le titane\index{titane},
    $\frac{c}{a}=\np{1,59}$ et pour le cadmium\index{cadmium},
...
\begin{ex}[Structure cfc : le fer $\alpha$]\index{fer}
    $a = 356$pm,
    $M = \np{55,8}$g.mol$^{-1}$.
    \begin{compactitem}
...
\end{ex}
\begin{ex}[Structure hc : le magnésium]\index{magnésium}
    $a = 320$pm,
    $M = \np{24,3}$g.mol$^{-1}$
    \begin{compactitem}
...
\end{rem}
\begin{ex}[Na]\index{Na}\index{sodium}
    $r = 190$pm, $M = \np{23,0}$g.mol$^{-1}$
\end{ex}
...
\begin{itemize}
    ...
    \item propriétés mécaniques de dureté\footnote{résistance à
        ...
        \index{propriétés mécaniques}\index{solidité|see{propriétés mécaniques}}
...
\begin{ex}[Alliages de fer]\index{fer!alliages}
    \begin{compactdesc}
        \item[Fonte] fer et carbone, carbone\index{carbone} à plus de $\np{2,1}$\%
            et jusqu'à $\np{6,7}$\% en masse\index{fonte}
        \item[Acier]\index{acier} fer et carbone (moins de $\np{2,1}$\% en masse
            de carbone) et traces éventuelles de nickel, chrome,
            molybdène en faible pourcentage ($<4$\%)
            \index{nickel}\index{chrome}\index{molybdène}
    \end{compactdesc}
\end{ex}
\begin{ex}[Alliages de cuivre]\index{cuivre}
    \begin{compactdesc}
        \item[Bronze] cuivre et étain (l'airin est l'ancien nom
            du bronze)\index{bronze}
        \item[Laiton] cuivre et zinc\index{laiton}
            \index{zinc}
    \end{compactdesc}
\end{ex}
\index{CC|)}
