...
\begin{figure}
    ...
    {\includegraphics[width=4cm]{chap3/nacl_maille eclatee.png}
...
\begin{figure}
    \centering
    \includegraphics[width=6cm]{chap3/voisins_nacl.png}
...
\begin{figure}
    \centering
    \includegraphics[width=6cm]{chap3/fluorine.png}
...
\index{énergie de cohésion!CaF$_2$}
